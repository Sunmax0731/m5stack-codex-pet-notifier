...
| Dashboard GUI | 状態確認、debug snapshot、event 送信、Decision 返信確認、最新 Codex session 回答表示、現在 pet preview、Core2 / GRAY preview、表示倍率 / RGBA / beep 調整、環境構築 command modal | `src/host-bridge/dashboard/` |
